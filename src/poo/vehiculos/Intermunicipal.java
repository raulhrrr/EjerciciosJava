...
public class Intermunicipal extends TransporteBase {
    ...
    public Intermunicipal(Integer numeroPuertas, String color, String matricula, Float tamanio, Float velocidadMax, Float velocidadMin, Integer numeroVentanas, Float tarifa, Integer numeroRuedas, Integer numeroSillas, Integer capacidadPasajeros) {
